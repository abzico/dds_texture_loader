...
///
/// Find the maximum number between the two input integer numbers.
///
/// \param a Number a
/// \param b Number b
/// \return Return maximum number between the two.
///
extern int krr_math_max(int a, int b);

///
/// Find the minimum number between the two input integer numbers.
///
/// \param a Number a
/// \param b Number b
/// \return Return minimum number between the two.
///
